...
namespace tars
{
    ...
    public:
        ...
        static string MD5()
        {
            return "ae2eca55a0818d81efce9903965e4190";
        }
        ServerDescriptor()
        {
            resetDefautlt();
        ...
        tars::JsonValueObjPtr writeToJson() const
        {
            ...
            p->value["runType"] = tars::JsonOutput::writeJson(runType);
            p->value["baseImage"] = tars::JsonOutput::writeJson(baseImage);
            p->value["sha"] = tars::JsonOutput::writeJson(sha);
            p->value["baseImageId"] = tars::JsonOutput::writeJson(baseImageId);
            return p;
        }
        string writeToJsonString() const
        {
        ...
        void readFromJson(const tars::JsonValuePtr & p, bool isRequire = true)
        {
            ...
            tars::JsonInput::readJson(runType,pObj->value["runType"], false);
            tars::JsonInput::readJson(baseImage,pObj->value["baseImage"], false);
            tars::JsonInput::readJson(sha,pObj->value["sha"], false);
            tars::JsonInput::readJson(baseImageId,pObj->value["baseImageId"], false);
        }
        void readFromJsonString(const string & str)
        {
            readFromJson(tars::TC_Json::getValue(str));
