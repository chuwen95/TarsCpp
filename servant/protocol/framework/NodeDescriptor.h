...
namespace tars
{
    ...
    {
        return tars::TC_Common::equal(l.avg1,r.avg1) && tars::TC_Common::equal(l.avg5,r.avg5) && tars::TC_Common::equal(l.avg15,r.avg15) && l.avgCpu == r.avgCpu;
    }
    inline bool operator!=(const LoadInfo&l, const LoadInfo&r)
    {
        return !(l == r);
    ...
    struct ReportNode : public tars::TarsStructBase
    {
    public:
        static string className()
        {
            return "tars.ReportNode";
        }
        static string MD5()
        {
        ...
        void readFromJson(const tars::JsonValuePtr & p, bool isRequire = true)
        {
            ...
            tars::JsonValueObjPtr pObj=tars::JsonValueObjPtr::dynamicCast(p);
            tars::JsonInput::readJson(nodeName,pObj->value["nodeName"], true);
            tars::JsonInput::readJson(sid,pObj->value["sid"], true);
        }
        void readFromJsonString(const string & str)
        {
            readFromJson(tars::TC_Json::getValue(str));
    ...
    inline bool operator==(const ReportNode&l, const ReportNode&r)
    {
        return l.nodeName == r.nodeName && l.sid == r.sid;
    }
    inline bool operator!=(const ReportNode&l, const ReportNode&r)
    {
        return !(l == r);
    }
    inline ostream& operator<<(ostream & os,const ReportNode&r)
    {
        os << r.writeToJsonString();
        return os;
    }
    inline istream& operator>>(istream& is,ReportNode&l)
    {
        std::istreambuf_iterator<char> eos;
        std::string s(std::istreambuf_iterator<char>(is), eos);
        l.readFromJsonString(s);
    ...
    public:
        ...
        static string MD5()
        {
            return "305a5e93ecdf6ba6427103eb23381180";
        }
        ServerStateInfo()
        {
            resetDefautlt();
        ...
        tars::JsonValueObjPtr writeToJson() const
        {
            ...
            p->value["exState"] = tars::JsonOutput::writeJson(exState);
            return p;
        }
        string writeToJsonString() const
        {
        ...
        void readFromJson(const tars::JsonValuePtr & p, bool isRequire = true)
        {
            ...
            tars::JsonValueObjPtr pObj=tars::JsonValueObjPtr::dynamicCast(p);
            tars::JsonInput::readJson(serverState,pObj->value["serverState"], true);
            ...
            tars::JsonInput::readJson(exState,pObj->value["exState"], false);
        }
        void readFromJsonString(const string & str)
        {
            readFromJson(tars::TC_Json::getValue(str));
        ...
        ostream& displaySimple(ostream& _os, int _level=0) const
        {
            ...
            _ds.displaySimple(exState, false);
            return _os;
        }
    public:
        ...
        map<std::string, std::string> exState;
    };
    inline bool operator==(const ServerStateInfo&l, const ServerStateInfo&r)
    {
        return l.serverState == r.serverState && l.processId == r.processId && l.nodeName == r.nodeName && l.application == r.application && l.serverName == r.serverName && l.settingState == r.settingState && l.exState == r.exState;
    }
    inline bool operator!=(const ServerStateInfo&l, const ServerStateInfo&r)
    {
        return !(l == r);
